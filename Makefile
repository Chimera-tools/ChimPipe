...
write: ChimPipe.sh
	@echo
	@echo "2) Write a temporary bash script"  
	@echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
run:
	@echo "3) Execute the script to add code to ChimPipe.sh to define an" 
	@echo "environmental variable with the directory where the pipeline is placed " 
	@echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"	
	@$(shell bash temp.sh)
	@echo "done"
